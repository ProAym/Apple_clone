...
function Model(props) {
  const basePath = import.meta.env.BASE_URL;   // ✅ This handles local and GitHub Pages base
  const { nodes, materials } = useGLTF(`${basePath}models/scene.glb`);
...
// ✅ Preload using the same basePath trick
